...
* Here are some features of this project
  ...
  * 12hr Traffic usage (calculated by itpmon results from prometheus)
...
* Set your LAN interface to assign out the DNS IP of your home server
* restarts services
</pre>

* Note: I removed the interface dns as it was causing some issues if you don't have Adguard home running on your docker server. If you do, uncomment the DNS part of the script so Adguard home can see the hostnames of the devices. 
...
## Troubleshooting: 
* Run these commands manually if you cannot find the iptmon in luci_statistics firewall. 
```
